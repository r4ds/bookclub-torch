--- 
title: "Deep Learning and Scientific Computing with R torch Book Club"
...
link-citations: yes
github-repo: r4ds/bookclub-torch
description: "This website is the product of the Data Science Learning Community's Deep Learning and Scientific Computing with R torch Book Club."
---

# Welcome {-}

Welcome to the Deep Learning and Scientific Computing with R torch book club! 

This website is a companion for the book [_Deep Learning and Scientific Computing with R torch_](https://skeydan.github.io/Deep-Learning-and-Scientific-Computing-with-R-torch) by Sigrid Keydana (copyright 2023).
This companion is available at [dslc.io/torch](https://dslc.io/torch).
...
- More information about how to present is available in the [github repo](https://github.com/r4ds/bookclub-torch).
